  ...
  return (
    <>
      <Form.Group className="mb-3" controlId="formBasicEmail1">
        ...
        <SelectCuti  readOnly={props?.disabledAll}
          name="jenis_cuti"
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail1">
        ...
        <SelectDetailJenisCuti  readOnly={props?.disabledAll}
          parent_id={fields?.jenis_cuti}
          value={fields?.detail_jenis_cuti}
          name="detail_jenis_cuti"
          onChange={(e) => {
            onChangeField(e, 'detail_jenis_cuti');
          }}
        />
        <Form.Text className="text-muted"></Form.Text>
      </Form.Group>
